...
interface chiefcomplaint__id_Buffer {
  0: any;
  1: any;
  2: any;
  3: any;
...
const chiefcomplaint__id_BufferSchema: Schema = new Schema({
...
interface chiefcomplaint__id {
  buffer: chiefcomplaint__id_Buffer;

}

const chiefcomplaint__idSchema: Schema = new Schema({
  buffer: { type: chiefcomplaint__id_BufferSchema, required: true },

});

interface chiefcomplaint_Patientdetails {
  state: any;
  lastname: any;
  firstname: any;
  homephone: any;
...
const chiefcomplaint_PatientdetailsSchema: Schema = new Schema({
...
interface Chiefcomplaint extends Document {
  _id: chiefcomplaint__id;
  encounterreasons: any;
  totalcount: any;
  patientdetails: chiefcomplaint_Patientdetails;

}

const ChiefcomplaintModelSchema: Schema = new Schema({
  _id: { type: chiefcomplaint__idSchema, required: true },
  encounterreasons: { type: Schema.Types.Mixed, required: true },
  totalcount: { type: Schema.Types.Mixed, required: true },
  patientdetails: { type: chiefcomplaint_PatientdetailsSchema, required: true },

});

const ChiefcomplaintModel = mongoose.model<Chiefcomplaint>('chiefcomplaint', ChiefcomplaintModelSchema, 'chiefcomplaint');
