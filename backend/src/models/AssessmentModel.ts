...
interface assessment__id_Buffer {
  0: any;
  1: any;
  2: any;
  3: any;
...
const assessment__id_BufferSchema: Schema = new Schema({
...
interface assessment__id {
  buffer: assessment__id_Buffer;

}

const assessment__idSchema: Schema = new Schema({
  buffer: { type: assessment__id_BufferSchema, required: true },

});

interface assessment_Patientdetails {
  state: any;
  lastname: any;
  firstname: any;
  homephone: any;
...
const assessment_PatientdetailsSchema: Schema = new Schema({
...
interface Assessment extends Document {
  _id: assessment__id;
  patientdetails: assessment_Patientdetails;
  assessment: any;

}

const AssessmentModelSchema: Schema = new Schema({
  _id: { type: assessment__idSchema, required: true },
  patientdetails: { type: assessment_PatientdetailsSchema, required: true },
  assessment: { type: Schema.Types.Mixed, required: true },

});

const AssessmentModel = mongoose.model<Assessment>('assessment', AssessmentModelSchema, 'assessment');
