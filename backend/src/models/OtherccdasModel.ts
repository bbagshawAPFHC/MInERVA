...
interface otherccdas__id_Buffer {
  0: any;
  1: any;
  2: any;
  3: any;
...
const otherccdas__id_BufferSchema: Schema = new Schema({
...
interface otherccdas__id {
  buffer: otherccdas__id_Buffer;

}

const otherccdas__idSchema: Schema = new Schema({
  buffer: { type: otherccdas__id_BufferSchema, required: true },

});

interface otherccdas_Patientdetails {
  state: any;
  lastname: any;
  firstname: any;
  homephone: any;
...
const otherccdas_PatientdetailsSchema: Schema = new Schema({
...
interface Otherccdas extends Document {
  _id: otherccdas__id;
  totalcount: any;
  patientdetails: otherccdas_Patientdetails;
  OtherCCDAS: any;

}

const OtherccdasModelSchema: Schema = new Schema({
  _id: { type: otherccdas__idSchema, required: true },
  totalcount: { type: Schema.Types.Mixed, required: true },
  patientdetails: { type: otherccdas_PatientdetailsSchema, required: true },
  OtherCCDAS: { type: Schema.Types.Mixed, required: true },

});

const OtherccdasModel = mongoose.model<Otherccdas>('otherccdas', OtherccdasModelSchema, 'otherccdas');

export default OtherccdasModel;