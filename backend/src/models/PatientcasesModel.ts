...
interface patientcases__id_Buffer {
  0: any;
  1: any;
  2: any;
  3: any;
...
const patientcases__id_BufferSchema: Schema = new Schema({
...
interface patientcases__id {
  buffer: patientcases__id_Buffer;

}

const patientcases__idSchema: Schema = new Schema({
  buffer: { type: patientcases__id_BufferSchema, required: true },

});

interface patientcases_Patientdetails {
  state: any;
  lastname: any;
  firstname: any;
  homephone: any;
...
const patientcases_PatientdetailsSchema: Schema = new Schema({
...
interface Patientcases extends Document {
  _id: patientcases__id;
  patientcases: any;
  totalcount: any;
  patientdetails: patientcases_Patientdetails;

}

const PatientcasesModelSchema: Schema = new Schema({
  _id: { type: patientcases__idSchema, required: true },
  patientcases: { type: Schema.Types.Mixed, required: true },
  totalcount: { type: Schema.Types.Mixed, required: true },
  patientdetails: { type: patientcases_PatientdetailsSchema, required: true },

});

const PatientcasesModel = mongoose.model<Patientcases>('patientcases', PatientcasesModelSchema, 'patientcases');

export default PatientcasesModel;